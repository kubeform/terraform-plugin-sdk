...
go test -o "$OUTDIR/e2etest$GOEXE" -c -ldflags "-X github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/command/e2etest.terraformBin=./terraform$GOEXE" github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/command/e2etest
