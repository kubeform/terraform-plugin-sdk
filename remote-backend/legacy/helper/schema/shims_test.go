...
import (
	...
	"github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/legacy/helper/hashcode"
	"github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/legacy/terraform"
