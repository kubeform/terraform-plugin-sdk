...
import (
	...
	"github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/legacy/helper/schema"
	statespkg "github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/states"
