...
import (
	...
	"github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/configs/configload"
	"github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/configs/configschema"
	"github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/copy"
	"github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/getproviders"
	"github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/initwd"
	legacy "github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/legacy/terraform"
	_ "github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/logging"
	"github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/plans"
	"github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/plans/planfile"
	"github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/providers"
	"github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/registry"
	"github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/states"
	"github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/states/statefile"
	...
	"github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/terraform"
