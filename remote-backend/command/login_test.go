...
import (
	...
	"github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/command/cliconfig"
	oauthserver "github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/command/testdata/login-oauth-server"
	tfeserver "github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/command/testdata/login-tfe-server"
