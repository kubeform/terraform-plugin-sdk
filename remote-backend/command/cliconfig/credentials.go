...
import (
	...
	pluginDiscovery "github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/plugin/discovery"
	"github.com/hashicorp/terraform-plugin-sdk/v2/remote-backend/replacefile"
)
